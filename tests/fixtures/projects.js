...
export const PROJECT_WITH_TASKS = {
  ...
  tasks: [
    { id: 'task-1', title: '아키텍처 설계', assignee: 'cto', description: '시스템 아키텍처를 설계합니다', phase: 1, dependencies: [], status: 'completed' },
    { id: 'task-2', title: 'API 구현', assignee: 'backend', description: 'REST API를 구현합니다', phase: 1, dependencies: [], status: 'executing' },
    { id: 'task-3', title: '테스트 작성', assignee: 'qa', description: '단위 테스트를 작성합니다', phase: 2, dependencies: ['task-1', 'task-2'], status: 'pending' },
    { id: 'task-4', title: 'UI 구현', assignee: 'frontend', description: '프론트엔드 UI를 구현합니다', phase: 2, dependencies: ['task-1'], status: 'pending' },
  ],
};
