...
| --- | ------------------- | ------------- | ----------- | ---------------------------------------- |
| 1   | `good-vibe:hello`   | 환경 설정     | 2-3분       | (자동) → 도구 확인 + CLAUDE.md 생성/개선 |
| 2   | `good-vibe:new`     | 프로젝트 시작 | 3-5분       | 아이디어 → PRD + 팀 구성 + 모드 선택     |
...
| 7   | `good-vibe:modify`  | 프로젝트 수정 | 5-15분      | 수정 요청 → 기존 프로젝트 기능 추가/변경 |
...
> `good-vibe:hello` 없이 `good-vibe:new`로 바로 시작할 수도 있습니다. 환경 설정이 이미 되어 있을 때.
...
에이전트가 내부적으로 사용하는 CLI 커맨드가 약 120개 있습니다.
