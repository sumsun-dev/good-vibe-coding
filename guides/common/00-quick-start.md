...
> - 코드에서 SDK로 쓰려면 [SDK 사용 가이드](09-sdk-usage.md)
...
> 아래 플로우는 plan-only 모드 기준입니다. plan-execute 모드에서는 Step 4(`good-vibe:approve`)를 건너뜁니다. quick-build 모드에서는 Step 3-4를 건너뛰고 바로 실행합니다.
...
│  good-vibe:discuss(1라운드) → 자동 승인 → good-vibe:execute → 완료
│
...
💬 토론 라운드 1/3 시작
   ...
   [Tier 1] CTO, PO 분석 중...
   [Tier 2] Fullstack, Frontend 분석 중...
   [Tier 3] QA, Security 분석 중...
   [Tier 4] Tech Writer 보완 중...
...
| ----------- | ----------------- | ------------------- | ----------------------------- |
| 토론        | 생략              | 1라운드 (자동 승인) | 최대 3라운드 (CEO 승인 필요)  |
| 팀 규모     | 2-3명             | 3-5명               | 5-8명                         |
