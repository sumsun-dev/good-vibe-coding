...
| `good-vibe:onboarding`  | 초기 환경 설정 마법사                    | 처음 시작할 때 (1회)    |
...
| 스킬                | 뭘 하나요?              | 언제 켜지나요?                   |
| ------------------- | ----------------------- | -------------------------------- |
| `onboarding-wizard` | 대화형 온보딩 진행      | `good-vibe:onboarding` 입력 시   |
...
| 학생      | `good-vibe:learn`, `good-vibe:onboarding`    | beginner-guide, mentor-kr          |
