...
| 3    | [퀵스타트](common/00-quick-start.md)               | `/gv` 한 줄 진입 + task-graph 흐름 — 실제 출력 예시 포함           |
...
| 가이드                                                     | 설명                                                                        |
| ---------------------------------------------------------- | --------------------------------------------------------------------------- |
| [커맨드와 스킬](common/03-commands-and-skills.md)          | v2 슬래시 6개 + 내장 스킬 5개 — 커맨드 vs 스킬 개념과 활성화 방식           |
| [커맨드 레퍼런스](common/03-commands-reference.md)         | `/gv` + 5 보조 슬래시 상세, 5개 작업 유형, 상태 전이, v1 → v2 매핑          |
...
| [고급 커맨드 마이그레이션](common/12-advanced-commands.md) | v1의 9개 고급 명령(scaffold, preset, eval 등) → v2 매핑 노트                |
...
| [CEO 가이드](common/11-ceo-guide.md)             | 비개발자 CEO를 위한 안내 — 의사결정 시점, 에스컬레이션 판단, Phase 지침  |
