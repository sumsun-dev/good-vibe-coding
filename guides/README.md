...
| 가이드                                             | 설명                                                                        |
| -------------------------------------------------- | --------------------------------------------------------------------------- |
| [커맨드와 스킬](common/03-commands-and-skills.md)  | 20개 커맨드 + 5개 스킬 — 어떤 커맨드가 있고 언제 쓰는지                     |
...
| [고급 커맨드](common/12-advanced-commands.md)      | 9개 고급 커맨드 상세 — scaffold, preset, eval 등 세부 설정과 관리           |
