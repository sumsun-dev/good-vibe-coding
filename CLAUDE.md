...
| `scripts/lib/engine/`  | 25   | task-graph-runner, task-graph-actions, task-router, task-graph-presets, risk-evaluator, orchestrator, execution-loop, review-engine, code-materializer, mode-dispatcher, plan-only-runner |
