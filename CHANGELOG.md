...
## [2.0.0-rc.5] - 2026-05-25

> **RC 5** — AI 활용 역량 평가 커맨드 추가. 개인/팀의 AI 활용도를 증거 기반 루브릭으로 진단하고 30일 액션 플랜을 생성.

### Added

- **`/good-vibe:ai-assess` 슬래시** — 문서/폴더/레포/대화 자료를 기반으로 AI 활용 역량 평가 리포트 생성
- **7축 평가 루브릭** — 문제 정의, 컨텍스트 설계, 워크플로우화, 도구 오케스트레이션, 검증과 품질관리, 산출물 임팩트, 조직 확산
- **증거 기반 판정 체계** — E0-E3 증거 등급, 점수 캡/감점 규칙, 직무별 보정 기준, L1-L5 레벨 필수 조건
