...
- `planning` → `good-vibe:discuss` (토론 시작/계속)
- `approved` → `good-vibe:execute` (작업 실행) 또는 `good-vibe:report` (보고서)
- `executing` → 진행 상황 표시
- `reviewing` → 리뷰 진행 중, 완료 대기
- `completed` → `good-vibe:report`, `good-vibe:feedback`
