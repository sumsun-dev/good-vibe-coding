...
`good-vibe:execute`에서 크로스 모델 리뷰(Claude + Gemini)를 사용하려면 Gemini CLI가 필요합니다.
...
다음 단계:
  good-vibe:new — 프로젝트 기획 (복잡도 분석 + 팀 구성)
```
