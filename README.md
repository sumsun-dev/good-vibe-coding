...
코드를 직접 관리하고 싶다면 `good-vibe:hello`로 프로젝트 폴더와 GitHub 저장소를 먼저 만들고 `good-vibe:new`를 실행하세요.
...
| 단계 | 커맨드              | 뭘 하나요?                                                                             | 걸리는 시간 |
| ---- | ------------------- | -------------------------------------------------------------------------------------- | ----------- |
| 1    | `good-vibe:hello`   | 프로젝트 폴더와 GitHub 저장소를 만듭니다. GitHub CLI가 있으면 저장소까지 자동 생성     | 2-3분       |
...
> `good-vibe:hello` 없이 `good-vibe:new`만으로도 시작할 수 있습니다. 코드 생성/관리가 필요하면 `good-vibe:hello`를 먼저, 기획서와 보고서만 필요하면 `good-vibe:new`로 바로 시작하세요.
...
`good-vibe:hello`에서 GitHub 협업 모드를 활성화하면:
...
| 커맨드              | 설명                                                        |
| ------------------- | ----------------------------------------------------------- |
| `good-vibe:hello`   | 프로젝트 폴더 + GitHub 저장소 생성                          |
...
| `good-vibe:onboarding`  | 사용자 환경 초기 설정 (한 번만 하면 됨)           |
...
`good-vibe:hello`로 기존 프로젝트 폴더를 지정하면, `codebase-scanner`가 기술 스택과 구조를 파악합니다. 이 정보가 팀 구성과 토론에 반영됩니다.
