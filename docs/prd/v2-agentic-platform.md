...
| 항목      | 값                                                                                                                                            |
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| 버전      | v2.7 (C-pre1/2 + 작업 13 완료, 작업 14 RC 단계 진입)                                                                                          |
| 작성일    | 2026-04-26 (v2.7 갱신: 2026-04-27)                                                                                                            |
| 작성자    | sose (CEO) + Claude (기획 보조)                                                                                                               |
| 상태      | **2.0.0-rc.1 RC 릴리즈 단계** — C-pre1/2 + 작업 13 (v1 데이터 호환성 회귀 테스트, 12 케이스) 완료. CEO 도그푸딩 후 정식 v2.0.0 승급 여부 결정 |
