...
| 항목      | 값                                                                                                                                                                                        |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 버전      | v2.6 (C-pre1/2 완료, Phase C 본 작업 진입 가능)                                                                                                                                           |
| 작성일    | 2026-04-26 (v2.6 갱신: 2026-04-27)                                                                                                                                                        |
| 작성자    | sose (CEO) + Claude (기획 보조)                                                                                                                                                           |
| 상태      | **Phase C 본 작업 진입 가능** — C-pre1 (internal/ 점검) + C-pre2 (commands/skills/guides 교차 참조 정리, 6 PR) 완료. 다음: §10 작업 13 (영속 데이터 회귀 테스트), 작업 14 (메이저 릴리즈) |
